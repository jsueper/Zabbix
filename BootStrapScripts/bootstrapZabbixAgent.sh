...
sudo grep -A20 "### Option: UserParameter" zabbix_agentd.conf | sed -i  's/# UserParameter=/UserParameter=AWS-QS-TEST,sudo su \&\& cd \/home\/ec2-user\/AWS-QS-TESTING\/ \&\& .\/serverspec.sh/' zabbix_agentd.conf
