...
aws cloudformation create-stack --template-url https://s3.amazonaws.com/"${bucket}/${key}/RootTemplate"/RootNestedTemplate.json --stack-name ZG --parameters file://paramsNested.json --disable-rollback --capabilities CAPABILITY_IAM
