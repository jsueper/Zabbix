...
aws cloudformation create-stack --template-url https://s3.amazonaws.com/"${bucket}/${key}"/GrafanaInstallTemplate.json --stack-name GRAFANA-DEPLOY --parameters file://paramsGrafana.json --disable-rollback --capabilities CAPABILITY_IAM
